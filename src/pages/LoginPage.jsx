...
const LoginPage = () => {
  ...
  <button
    type="submit"
    className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-blue-700 font-semibold rounded-md disabled:opacity-50 transition-all duration-200 shadow-md hover:shadow-lg"
