          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
            ...
            {!showHistory && (
              <button
                ...
                className={`w-full sm:w-auto rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed gradient-bg ${selectedItemsCount > 0 && !isSubmitting
                  ? "border border-purple-200 text-white-700 hover:border-purple-300 hover:bg-purple-100"
                  ...
                  `}
                          >
                            <td className="px-6 py-4 min-w-[50px] relative">
                              {isTodayTask && (
                                <div className="absolute -top-3 left-0 bg-amber-500 text-white text-xs font-bold px-3 py-1 rounded-b-md shadow-md z-10 whitespace-nowrap">
                                  TODAY
                                </div>
                              )}
                              <input
                    ...
                    return (
                      <div key={account._id} className={`bg-white border border-gray-200 rounded-lg p-4 shadow-sm ${isSelected ? "bg-purple-50 border-purple-200" : ""
                        ...
                        <div className="space-y-3">
                          {/* Checkbox */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 mr-2 whitespace-nowrap shrink-0">Select:</span>
                            <input
                              type="checkbox"
                          ...
                          {/* Task ID */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Task ID:</span>
                            <div className="text-sm text-gray-900 break-words">
                              {account["col1"] || "—"}
                            </div>
                          </div>
                          ...
                          {/* Department */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Department:</span>
                            <div className="text-sm text-gray-900 break-words">
                              {account["col2"] || "—"}
                            </div>
                          </div>
                          ...
                          {/* Given By */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Given By:</span>
                            <div className="text-sm text-gray-900 break-words">
                              {account["col3"] || "—"}
                            </div>
                          </div>
                          ...
                          {/* Description */}
                          <div className="flex justify-between items-start border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Description:</span>
                            <div className="text-sm text-gray-900 break-words text-right max-w-[60%]">
                              {account["col5"] || "—"}
                            </div>
                          </div>
                          ...
                          {/* End Date */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">End Date:</span>
                            <div className="text-sm text-gray-900 break-words">
                              {formatDateTimeForDisplay(account["col6"])}
                            </div>
                          </div>
                          ...
                          {/* Planned Date */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Planned Date:</span>
                            <div className="text-sm text-gray-900 break-words">
                              {formatDateTimeForDisplay(account["col10"])}
                            </div>
                          </div>
                          ...
                          {/* Next Target Date */}
                          <div className="flex justify-between items-center border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Next Target Date:</span>
                            <input
                              type="date"
                          ...
                          {/* Remarks */}
                          <div className="flex justify-between items-start border-b pb-2">
                            <span className="text-sm font-medium text-gray-700 shrink-0">Remarks:</span>
                            <textarea
                              placeholder="Enter remarks"
                              disabled={!isSelected}
                              value={remarksData[account._id] || ""}
                          ...
                          <div className="text-sm">
                            <span className="text-sm font-medium block mb-1">Upload Image:</span>
                            {account.image ? (
