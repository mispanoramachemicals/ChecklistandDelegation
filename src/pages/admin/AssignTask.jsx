          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between bg-gradient-to-r from-purple-50 to-pink-50 p-6 border-t border-purple-100">
              ...
              <button
                ...
                className="rounded-md border gradient-bg border-purple-200 py-2 px-4 text-white hover:border-purple-300 hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
