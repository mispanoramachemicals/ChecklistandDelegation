          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            {!showHistory && (
              <button
                ...
                className={`rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200 w-full sm:w-auto gradient-bg ${isSubmitEnabled && !isSubmitting
                  ? "border border-purple-200  text-white hover:border-purple-300 hover:bg-purple-100 cursor-pointer"
              ...
              <div className="p-3 sm:p-4 bg-gradient-to-r from-purple-50 to-pink-50 border-b border-purple-100">
                ...
                {dateFilter !== "all" && (
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold ${dateFilter === "today" ? "bg-amber-100 text-amber-700" :
